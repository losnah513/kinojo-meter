...
namespace KinojoMeterLauncher
{
    ...
    internal sealed class ShellModuleReleaseManifest
    {
        public int SchemaVersion { get; set; }
        public string Channel { get; set; }
    ...
    internal sealed class ShellModuleUpdateAuthorization
    {
        public bool Authorized { get; set; }
        public string Code { get; set; }
        public string Message { get; set; }
        public ShellModuleReleaseManifest Release { get; set; }
    }

    internal sealed class ActiveShellModuleState
    {
        public int SchemaVersion { get; set; }
        public string Channel { get; set; }
        public string ModuleId { get; set; }
    ...
    internal sealed class ShellModuleInstallResult
    {
        public ActiveShellModuleState Active { get; set; }
        public ActiveShellModuleState Previous { get; set; }
        public bool Changed { get; set; }
        public bool Downloaded { get; set; }
    }

    internal sealed class PrivateRuntimeReleaseManifest
    {
        public int SchemaVersion { get; set; }
        public string Channel { get; set; }
        public string ModuleId { get; set; }
    ...
    internal sealed class PrivateRuntimeUpdateAuthorization
    {
        public bool Authorized { get; set; }
        public string Code { get; set; }
        public string Message { get; set; }
        public PrivateRuntimeReleaseManifest Release { get; set; }
    }

    internal sealed class ActivePrivateRuntimeState
    {
        public int SchemaVersion { get; set; }
        public string Channel { get; set; }
        public string ModuleId { get; set; }
    ...
    internal sealed class PrivateRuntimeInstallResult
    {
        public ActivePrivateRuntimeState Active { get; set; }
        public ActivePrivateRuntimeState Previous { get; set; }
        public bool Changed { get; set; }
        public bool Downloaded { get; set; }
    }
    ...
    internal sealed class ProtocolModuleReleaseManifest
    {
        public int SchemaVersion { get; set; }
        public string Channel { get; set; }
        public string ModuleId { get; set; }
    ...
    internal sealed class ProtocolModuleUpdateAuthorization
    {
        public bool Authorized { get; set; }
        public string Code { get; set; }
        public string Message { get; set; }
        public ProtocolModuleReleaseManifest Release { get; set; }
    }

    internal sealed class ActiveProtocolModuleState
    {
        public int SchemaVersion { get; set; }
        public string Channel { get; set; }
        public string ModuleId { get; set; }
    ...
    internal sealed class ProtocolModuleInstallResult
    {
        public ActiveProtocolModuleState Active { get; set; }
        public ActiveProtocolModuleState Previous { get; set; }
        public bool Changed { get; set; }
        public bool Downloaded { get; set; }
    }

    internal sealed class SyncModuleReleaseManifest
    {
        public int SchemaVersion { get; set; }
        public string Channel { get; set; }
        public string ModuleId { get; set; }
    ...
    internal sealed class SyncModuleUpdateAuthorization
    {
        public bool Authorized { get; set; }
        public string Code { get; set; }
        public string Message { get; set; }
        public SyncModuleReleaseManifest Release { get; set; }
    }

    internal sealed class ActiveSyncModuleState
    {
        public int SchemaVersion { get; set; }
        public string Channel { get; set; }
        public string ModuleId { get; set; }
    ...
    internal sealed class SyncModuleInstallResult
    {
        public ActiveSyncModuleState Active { get; set; }
        public ActiveSyncModuleState Previous { get; set; }
        public bool Changed { get; set; }
        public bool Downloaded { get; set; }
    }
}
