...
powershell.exe -NoProfile -ExecutionPolicy Bypass -File "%~dp0prepare-github-release.ps1" -GitHubOwner "%GH_OWNER%" -GitHubRepository "%GH_REPO%" -MinimumVersion "%MIN_VERSION%" -ReleaseNote "%RELEASE_NOTE%" -VerifyRemote
if errorlevel 1 (
  echo.
